...
message: >
    J'ai longuement hésité avant d'écrire ce premier article. Franchement, je me suis demandé si c'était encore utile. On parle d'IA partout, tout le temps — dans les médias, au bureau, à table. Les outils se multiplient, les usages aussi. Est-ce qu'il fallait vraiment ajouter un article de plus sur le sujet ?

    Et puis j'ai regardé autour de moi.

    J'ai vu des collègues utiliser ChatGPT ou Claude en tâtonnant, sans vraiment comprendre pourquoi ça marchait parfois bien et parfois très mal. J'ai vu des managers prendre des décisions sur des outils qu'ils ne comprenaient pas. J'ai vu des développeurs juniors copier-coller des architectures sans savoir ce qu'ils construisaient vraiment. Et j'ai vu des enfants, des parents, des gens curieux — intimidés par quelque chose qui, au fond, est beaucoup plus accessible qu'on ne le croit : C'est ça qui m'a convaincu de me lancer !
    
    Cette série n'est pas un cours magistral ou un manuel technique. C'est une tentative d'expliquer, du plus simple au plus complexe, comment ces systèmes fonctionnent vraiment — pour que tu puisses mieux les utiliser, mieux les questionner, et peut-être même en construire toi-même un jour.
date: 2026-03-26
tags: []
code-links:
  - python: 
